...
```bash
npm install @aarondewes/wp-notices
```
...
For more information about consuming from a data store, refer to [the `@aarondewes/wp-data` documentation on _Data Access and Manipulation_](/packages/data/README.md#data-access-and-manipulation).
