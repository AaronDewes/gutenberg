...
-   `ServerSideRender` is no longer part of components. It was extracted to an independent package `@aarondewes/wp-server-side-render`.
...
-   `withAPIData` has been removed. Please use the Core Data module or `@aarondewes/wp-api-fetch` directly instead.
